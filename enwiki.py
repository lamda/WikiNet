...
if __name__ == '__main__':
    ...
    # # wp.get_links(link_type='all', start=1100, stop=1150)
    # # wp.get_links(link_type='all', start=1150, stop=1175)
    # # wp.get_links(link_type='all', start=1175, stop=1200)
    # # wp.get_links(link_type='all', start=1200, stop=None)
